...
const nonStandardFlag = '<span class="nonstandard-flag" title="This module does not come with official Kengine distributions by default; it needs to be added to custom Kengine builds.">Non-standard</span>';
const standardFlag = '<span class="standard-flag" title="This module comes with official Kengine distributions by default.">Standard</span>';
...
function beginRenderingInto($tpl, moduleID, module) {
	...
	$('.top-doc', $tpl).html(markdown(replaceGoTypeNameWithKengineModuleName(rawDocs, module, moduleID)));
...
function replaceGoTypeNameWithKengineModuleName(docs, module, moduleID) {
	...
	// replace the type name with the Kengine module ID if it starts the docs.
