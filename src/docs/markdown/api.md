...
Exports Kengine's current configuration at the named path. Returns a JSON body.
...
Removes Kengine's configuration at the named path. DELETE deletes the target value.
